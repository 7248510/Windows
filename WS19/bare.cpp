...
//Identify the OS to determine the which function to run.(Aiming for cross compatibly between Linux & Windows, I don't use Mac)(Start learning Linux's api)
//Sign my code
...
int vboxExecute()
{
    ...
    bvirt centos[] = {"09b3289f-42ae-4578-ae12-122accd3bcbf"}; //Local machine
